  ...
  render(): JSX.Element {
    ...
    return (
        <PageFrame
            ...
            headerAreaElementDesktop={(
                <div>
                  <h4>Header Desktop</h4>
                </div>
            )}
            headerAreaElementMobile={(
                <div>
                  <h4>Header Mobile</h4>
                </div>
            )}
            commandAreaElementDesktop={(
                <div>
                  <h4>Command Desktop</h4>
                </div>
            )}
            commandAreaElementMobile={(
                <div>
                  <h4>Command Mobile</h4>
                </div>
            )}
        />
    );
