...
export interface IPageFrameProps {
    ...
    headerAreaElementDesktop?: React.ReactNode;
    headerAreaElementMobile?: React.ReactNode;

    commandAreaElementDesktop?: React.ReactNode;
    commandAreaElementMobile?: React.ReactNode;
